...
panel.innerHTML=`
<div id="vh-header">
<span id="vh-title">Energy spammer</span>
<div id="vh-controls">
...
<button id="vh-send">Send (single)</button>
<button id="vh-send-repeats">Send (repeats)</button>
<button id="vh-send-all">Send All Captures</button>
<button id="vh-clear">Clear Captures</button>
</div>
